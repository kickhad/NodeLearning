...
// // TODO Define MQTT Client
// // Forward Declaration

// uint8_t KfClient::connectMultiWiFi(void) {
// #if ESP32
...
// void KfClient::toggleLED() {
//     //toggle state
//     digitalWrite(LED_BUILTIN, !digitalRead(LED_BUILTIN));
// }

// void KfClient::heartBeatPrint(void) {
//     static int num = 1;
...
// void KfClient::publishMQTT(void) {
...
// void KfClient::check_status(void) {
...
// void KfConfig::loadConfigData(void) {
...
// void KfConfig::saveConfigData(void) {
...
// void KfClient::deleteOldInstances(void) {
...
// void KfClient::createNewInstances(void) {
//     if (!&client) {
//         WiFiClient _client;
//         this->client = &_client;
...
//     // AIO_SERVERPORT
//     ESP_WMParameter AIO_SERVERPORT_FIELD(AIO_SERVERPORT_Label, "AIO SERVER PORT", custom_AIO_SERVERPORT,
//                                          custom_AIO_PORT_LEN + 1);

//     // AIO_USERNAME
//     ESP_WMParameter AIO_USERNAME_FIELD(AIO_USERNAME_Label, "AIO USERNAME", custom_AIO_USERNAME,
